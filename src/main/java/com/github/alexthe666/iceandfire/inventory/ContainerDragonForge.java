...
public class ContainerDragonForge extends AbstractContainerMenu {
    ...
    public ContainerDragonForge(int id, Container furnaceInventory, Inventory playerInventory, ContainerData vars) {
        ...
        if (furnaceInventory instanceof BlockEntityDragonforge) {
            fireType = ((BlockEntityDragonforge) furnaceInventory).dragonType;
        } else if (IceAndFire.PROXY.getRefrencedTE() instanceof BlockEntityDragonforge) {
            fireType = ((BlockEntityDragonforge) IceAndFire.PROXY.getRefrencedTE()).dragonType;
        }
